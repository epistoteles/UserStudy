...
with st.form(key="annotation", clear_on_submit=True):
    ...
    st.markdown(data.iloc[0]['comment_markdown'])
    cols = st.columns(2)
    ...
    st.markdown(data.iloc[1]['comment_markdown'])
    cols = st.columns(2)
    ...
    st.markdown(data.iloc[2]['comment_markdown'])
    cols = st.columns(2)
    ...
    st.markdown(data.iloc[3]['comment_markdown'])
    cols = st.columns(2)
    ...
    st.markdown(data.iloc[4]['comment_markdown'])
    cols = st.columns(2)
